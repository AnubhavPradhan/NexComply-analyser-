...
class RiskReportGenerator:
            ...
            if data.get('questionnaire'):
                ...
                for category, score in category_scores.items():
                    writer.writerow([
                        ...
                        len([i for i in data['questionnaire'].items if i.category.value == category]),
                        score,
                        'Assessed'
                    ])
    ...
    def generate_json_report(self, data: Dict[str, any], filename: str = "risk_report.json") -> Path:
